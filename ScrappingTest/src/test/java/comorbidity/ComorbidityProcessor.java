...
public abstract class ComorbidityProcessor {
	...
	public static void readExcelAndProcess() {
		try {
			...
			List<String> hypothyroidismEliminate = hypothyroidismIngredients.getOrDefault("Eliminate",
					new ArrayList<>());
			...
			ComorbidityProcessor hypothyroidismProcessor = new HypothyroidismProcessor(hypothyroidismEliminate,
					hypothyroidismToAdd);
